            ...
            if (imageType === 'image/svg+xml') {
                ...
                Highcharts.imageToDataUrl(
                    ...
                    function (imageURL) {
                        ...
                        try {
                            // @change 变更1 注释本地导出下载功能
                            // Highcharts.downloadURL(imageURL, filename);
                            if (successCallback) {
                                // @change 变更2 将图片 image base 64 传出
                    ...
                    if (
                        ...
                        Highcharts.downloadSVGLocal(
                            ...
                            function successCallback(data) {
                              // @change 变更3 检查传入的方法 getImgBase64，如果有则将 base64 传入
                              exportingOptions.getImgBase64 && exportingOptions.getImgBase64(data)
                            }
                        );
                    }
                };
